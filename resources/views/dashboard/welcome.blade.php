...
@section('content')
    <div class="container-xxl bg-white p-0">
        ...
        <section class="py-5 text-center" style="background-color: #ffe5b4;">
            <div class="container">
              <h1 class="display-4 text-orange" style="color: #ff6600;">About Us</h1>
              <p class="lead" style="color: #cc5200;">Bringing people together through flavors, freshness, and food stories.</p>
            </div>
          </section>
              ...
              <div class="row justify-content-center">
                <div class="col-md-8">
                  <div class="card shadow-lg border-0" style="border-left: 5px solid #ff6600;">
                    <div class="card-body">
                      <h3 class="card-title" style="color: #ff6600;">Welcome to FareSync</h3>
                      <p class="card-text">
